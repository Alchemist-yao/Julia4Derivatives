...
function gamma(κ_r::Float64,σ_r::Float64)
    return √(κ_r^2+2*σ_r^2)
end

function b1(κ_r::Float64,θ_r::Float64,σ_r::Float64,r0::Float64,T::Float64)
    g=gamma(κ_r,σ_r)
...
function b2(κ_r::Float64,θ_r::Float64,σ_r::Float64,r0::Float64,T::Float64)
    g=gamma(κ_r,σ_r)
    result=2*(exp(g*T)-1)/(2*g+(κ_r+g)*(exp(g*T)-1))
    return result
end

function B(κ_r::Float64,θ_r::Float64,σ_r::Float64,r0::Float64,T::Float64)
...
#H93模型特征函数值
function H93_char_func(u,T::Float64,r::Float64,κ_v::Float64,θ_v::Float64,σ_v::Float64,ρ::Float64,v0::Float64)
    c1=κ_v*θ_v
...
#M76模型特征函数值
function M76_char_func(u,T::Float64,λ::Float64,μ::Float64,δ::Float64)
        ω=-λ*(exp(μ+0.5*(δ^2))-1)
...
#BCC模型特征函数值
function BCC_char_func(u,T::Float64,r::Float64,κ_v::Float64,θ_v::Float64,σ_v::Float64,ρ::Float64,v0::Float64,λ::Float64,μ::Float64,δ::Float64)
...
#H93模型欧式看涨期权值
function H93_call_func(S0::Float64,K::Float64,T::Float64,r::Float64,κ_v::Float64,θ_v::Float64,σ_v::Float64,ρ::Float64,v0)
...
#BCC模型欧式看涨期权值
function BCC_call_value(S0::Float64,K::Float64,T::Float64,r::Float64,κ_v::Float64,θ_v::Float64,σ_v::Float64,ρ::Float64,v0::Float64,λ::Float64,μ::Float64,δ::Float64)
